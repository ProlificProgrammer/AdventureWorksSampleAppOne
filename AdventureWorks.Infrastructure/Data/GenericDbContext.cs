...
using AdventureWorks.Core.Model.Person;
using AdventureWorks.Core.Model.Production;
...
namespace AdventureWorks.Infrastructure.Data
{
    public partial class GenericDbContext : DbContext
    {
       ...
       // public virtual DbSet<ErrorLog> ErrorLog { get; set; }
        ...
        public virtual DbSet<AdventureWorks.Core.Model.Person.Person> Person { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AdventureWorks.Core.Model.Person.Person>(entity =>
            {
                entity.HasKey(e => e.BusinessEntityId);
                ...
                entity.HasOne(d => d.BusinessEntity)
                    .WithOne(p => p.Person)
                    .HasForeignKey<AdventureWorks.Core.Model.Person.Person>(d => d.BusinessEntityId)
                    .OnDelete(DeleteBehavior.ClientSetNull);
            });
